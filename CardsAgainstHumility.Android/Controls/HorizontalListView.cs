...
namespace CardsAgainstHumility.Android.Controls
{
    ...
    [Preserve(AllMembers = true)]
    public class HorizontalListView : AdapterView<ArrayAdapter>
    {
        #region Fields
        ...
        public override ArrayAdapter Adapter
        {
            get { return _adapter; }
            set
            {
        ...
        public override void SetSelection(int position)
        {
            ...
            var child = GetChildAt(position);
        }

        private void FillList(int dx)
        {
            var edge = _displayOffset;
